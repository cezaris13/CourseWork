# from https://gist.github.com/jcmgray/e0ab3458a252114beecb1f4b631e19ab
import numpy as np
...
def sgd(
    ...
    **kwargs
    ...
    i += 1
    return OptimizeResult(x=x, fun=fun(x, args[0]), jac=g, nit=i, nfev=i, success=True,args=args)
